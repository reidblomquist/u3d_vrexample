...
namespace Shounds.IObj
{
    ...
    public class IObjManager : MonoBehaviour
    {
        ...
        [SerializeField] private IObjUIFader m_IObjMoveModeUIFader;                   // This fader controls the UI showing how to use SelectionSliders.
        [SerializeField] private SelectionSlider m_IObjMoveModeUISlider;          // This is the slider that is used to demonstrate how to use them.
        ...
        private IEnumerator Start ()
        {
            ...
            yield return StartCoroutine (m_IObjMoveModeUIFader.InteruptAndFadeIn ());
            yield return StartCoroutine (m_IObjMoveModeUISlider.WaitForBarToFill ());
            yield return StartCoroutine (m_IObjMoveModeUIFader.InteruptAndFadeOut ());
